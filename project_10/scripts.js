function loadMatches(){
    // query URL
    let queryURL = "https://cricapi.com/api/matches?apikey=fdTh9MMmd3OPiTFM4LTCr22Xr4s1";
    ...
    fetch(queryURL)
        ...
        .then(function (result) {
            console.log(result);
            displayMatchResult(result.matches);
        })
...
// call the loadMatches() after window loads
